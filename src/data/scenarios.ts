...
export const SCENARIO_CSR: Record<ScenarioId, CSRData> = {
  ...
  omni: {
    ...
    policy: { policyNumber: '440387261UL', product: 'Universal Life', status: 'Active', issueDate: '06/12/2018', state: 'CA' },
    billing: { paidTo: '03/01/2026', method: 'EFT', frequency: 'Monthly', premium: '$412.50' },
    ...
    coverages: [
      ...
      { label: 'Cash Value', value: '$187,420' },
      { label: 'Max Loanable (90%)', value: '$168,678' },
      { label: 'Loan Balance', value: '$75K — In Progress' },
      { label: 'Net Death Benefit', value: '$425,000 (post-loan)' },
      { label: 'Primary Bene', value: 'Lisa M. Chen' },
      { label: 'Contingent Bene', value: 'Pending Update' },
    ],
    coverageNote: 'Policy loan ($75K at 5.25% fixed) in progress. Beneficiary change form outstanding — minor dependent Emily R. Chen (DOB 04/15/2008), UTMA custodian: Lisa M. Chen.',
    activity: [
      { icon: '📞', iconColor: '#37A526', iconBg: '#e6f5e0', title: 'Phone — Policy Loan Finalization', timestamp: 'Today, 10:31 AM · Active', badge: 'Active', badgeColor: 'positive' },
      { icon: '💬', iconColor: '#1B75BB', iconBg: '#e0f0fc', title: 'Agent Chat — Loan Rate Comparison', timestamp: 'Today, 10:24 AM · 8 min', badge: 'Positive', badgeColor: 'positive' },
      { icon: '🤖', iconColor: '#7c5500', iconBg: '#fef3d6', title: 'AI Chatbot — Loan Inquiry', timestamp: 'Today, 10:19 AM · Max loan confirmed', badge: 'Escalated', badgeColor: 'cautionary' },
      { icon: '🌐', iconColor: '#808285', iconBg: '#F2F7F6', title: 'Self-Service Portal', timestamp: 'Today, 10:14 AM · Downloaded loan form PDF', badge: 'Neutral', badgeColor: 'neutral' },
    ],
  },
  callback: {
    banner: {
